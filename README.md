...
**Important**: you have to create README.template.md at the root and basically the package designed to modify only this file and do not touch README.md itself.
